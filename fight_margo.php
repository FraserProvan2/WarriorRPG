...
<body style="background-image: url('img/dark_embroidery.png');">
        ...
        <div class="row">
            <div class="col-md content-box fightBox">
                ...
                <div class="row">
                    ...
                    <h6 class="col oppName">Margo</h6>
                </div>

                <!--Artwork-->
                <img src="img/fights/margo.png" class="img-fluid rounded artwork">
                ...
                <div id="claim-response" class="row tools-div">
                    <button onclick="attackMargo()" class="col-md attack-block btn">Attack</button>
                    <button onclick="blockMargo()" class="col-md attack-block btn">Block</button>
                </div>
    ...
    <script>
        ...
        console.log("margos attack is " + opponent.attack);

        //margo Abilities
        function margoAbility() {

        }

        //margo Fight functions
        function attackMargo() {
            attack();
            MargoAbility();
        }
        ...
        function checkAlive() {
            ...
            if (opponent.health < 1) {
                ...
                div.innerHTML = "<a onclick='token1(); claim10();' href='http://fraserprovan.co.uk/projects/warriorRPG/main.php' class='col-md attack-block btn' >Claim Reward</a>";
            }
        }
        ...
        //margo health:
        var margoHealth = setInterval(function () {
